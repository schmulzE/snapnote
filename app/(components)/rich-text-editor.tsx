...
const RichTextEditor = ({ initialContent, noteId, folderId } : { initialContent: string | undefined, noteId: string | undefined, folderId?: string}) => {
  const [ formData , setFormData] = useState<FormData>({title: '', content: '',  createdBy: undefined, folder: undefined})
  ...
  return (
    <div className="bg-gray-200 p-2 rounded-full">
      ...
      <button
        ...
        className={`${editor.isActive({ textAlign: 'center' }) ? 'bg-blue-500 text-white' : ''} px-2 py-1 rounded`}
      >
